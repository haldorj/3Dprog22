...
CollisionVolume::CollisionVolume(int n) : m_rekursjoner(n), m_indeks(0), VisualObject()
{
...
//!
void CollisionVolume::lagTriangel(const QVector3D& v1, const QVector3D& v2,
const QVector3D& v3)
{
  ...
  //!
  void CollisionVolume::subDivide(const QVector3D& a, const QVector3D& b, const QVector3D& c, int n)
  {
     if (n>0) {
  ...
  //!
  void CollisionVolume::oktaederUnitBall()
  {
     QVector3D v0{0, 0, 1};
     QVector3D v1{1, 0, 0};
     QVector3D v2{0, 1, 0};
  ...
  //!
  void CollisionVolume::init(GLint matrixUniform)
  {
